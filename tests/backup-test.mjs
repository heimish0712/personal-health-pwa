...
const original = { format: BACKUP_FORMAT, backupVersion: 1, source: { appVersion: '0.10.0', dbVersion: 3, schemaVersion: 2, seedVersion: 1 }, exportedAt: time, scope: { type: 'profile', profileId: id(1) }, data, counts: backupCounts(data) };
...
await reject('BACKUP-VAL-005', (d) => { d.source.schemaVersion = 3; }, 'BACKUP_SCHEMA_UNSUPPORTED');
...
}, 'All portable DB3 unique indexes match the validator.');
...
reporter.finish('tests/results/v0.10.0-backup.json');
