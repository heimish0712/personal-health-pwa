...
export async function runQaFeedbackTests(test) {
  ...
  try {
    ...
    const services = { diet: c.dietService, calendar: c.calendarService, health: c.healthService, activity: c.passScheduleService, exerciseQuery: c.exerciseQueryService, exerciseLog: c.exerciseLogService };
