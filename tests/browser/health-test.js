...
export async function runHealthTests(test) {
  ...
  try {
    ...
    const context = { root, services: { health, activity: calendar.passScheduleService, exerciseQuery: calendar.exerciseQueryService }, setTitle() {}, showToast() {}, showError(m, error) { throw error; }, navigate() {}, isCurrent: () => true };
