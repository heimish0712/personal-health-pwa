...
| 8 | v0.10.0 Google Calendar 단방향 연동 | 예약 원본 유지, 기기 outbox/portable link/OAuth session, 실제 Google QA 별도 |
| 9 | Supabase/Auth/Sync | Profile 소유권 연결, Outbox, 재시도·충돌, 기기간 동기화, 원격 사진 저장 |
