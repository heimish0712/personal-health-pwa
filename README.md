...
v0.5.0에서 **운동 → 이용권 관리**, **캘린더 → 예약**을 사용할 수 있습니다. v0.6.0에서 **체중 → 일반 체중/인바디/변화 그래프**와 캘린더·홈 측정 요약을 사용할 수 있습니다. v0.7.0에서 **식단·사진과 ZIP Backup v2**를 사용할 수 있습니다. 다음 단계인 홈·통합 캘린더 완성, 운영 안정화, Supabase Sync는 [개발 로드맵](docs/ROADMAP.md)을 따릅니다.
