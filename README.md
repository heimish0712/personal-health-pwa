...
v0.5.0에서 **운동 → 이용권 관리**, **캘린더 → 예약**을 사용할 수 있습니다. v0.6.0에서 **체중 → 일반 체중/인바디/변화 그래프**와 캘린더·홈 측정 요약을 사용할 수 있습니다. 다음 단계인 식단·사진, 사진 포함 Backup v2, 홈·통합 캘린더 완성, Supabase Sync는 [개발 로드맵](docs/ROADMAP.md)을 따릅니다.
